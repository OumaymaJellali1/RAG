...
class NaiveRewardManager:
    ...
    def __call__(self, data: DataProto, val_type='f1', is_train=True):
...
class NaiveBatchRewardManager:
    ...
    def __call__(self, data: DataProto, val_type='f1', is_train=True, return_dict=False, default_batchsize=32):
        """We will expand this function gradually based on the available datasets"""
